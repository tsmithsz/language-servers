...
## [0.1.31](https://github.com/tsmithsz/language-servers/compare/chat-client/v0.1.30...chat-client/v0.1.31) (2025-08-04)
...
* add visibleName property to fix empty directory name when the directory ends with a slash ([#1302](https://github.com/tsmithsz/language-servers/issues/1302)) ([f6d573c](https://github.com/tsmithsz/language-servers/commit/f6d573cc8e6b23cfdcfd9baa5a5c8e705579b23c))
...
* **chat-client:** fix bug where pair programmer mode option update was not stored properly ([#1400](https://github.com/tsmithsz/language-servers/issues/1400)) ([bcdd9a2](https://github.com/tsmithsz/language-servers/commit/bcdd9a2b02a1e37aa83ac93ceef93d84a99951de))
...
* open initial tab using mynahUI defaults instead of waiting for ChatOptions ([#1322](https://github.com/tsmithsz/language-servers/issues/1322)) ([87178a5](https://github.com/tsmithsz/language-servers/commit/87178a554f23decb45fbdf26f067d0d9801f91a0))
...
* prefix if user reject/stop command, whole card should be dimmed ([#1212](https://github.com/tsmithsz/language-servers/issues/1212)) ([394db61](https://github.com/tsmithsz/language-servers/commit/394db61133e09cfaeff2f7510ab60c571c562130))
...
* remove @ mention in placeholder q chat text if agentic mode not available ([#1311](https://github.com/tsmithsz/language-servers/issues/1311)) ([28f84fc](https://github.com/tsmithsz/language-servers/commit/28f84fc82fd5e55ec1cdc61d1bcca6e4e447b12f))
...
* remove gradient from create prompt button ([#1475](https://github.com/tsmithsz/language-servers/issues/1475)) ([2f34d43](https://github.com/tsmithsz/language-servers/commit/2f34d438b08ced84c0a17303fd22d7f750c64dfd))
...
* Revert stop text align ([#1397](https://github.com/tsmithsz/language-servers/issues/1397)) ([439e859](https://github.com/tsmithsz/language-servers/commit/439e8597b5ce8ad052ab571a1a156044f8862206))
...
* stop buttom work expected ([#1307](https://github.com/tsmithsz/language-servers/issues/1307)) ([06c752e](https://github.com/tsmithsz/language-servers/commit/06c752e1dee106be73daa73f336213aad5413e67))
* stop chat response first when close tab ([#1292](https://github.com/tsmithsz/language-servers/issues/1292)) ([3733b43](https://github.com/tsmithsz/language-servers/commit/3733b433a771ece77ae83f55c8e8e3bd13dcd96b))
* Stop text align ([#1321](https://github.com/tsmithsz/language-servers/issues/1321)) ([0f522a1](https://github.com/tsmithsz/language-servers/commit/0f522a17004174d29955bf70c304ad9ca39df623))
* undo buttom not dimmed the card ([#1276](https://github.com/tsmithsz/language-servers/issues/1276)) ([49bd9c9](https://github.com/tsmithsz/language-servers/commit/49bd9c95d8f9213fe878720a20c13d8f045778ee))
...
* welcome card shows everytime ([#1332](https://github.com/tsmithsz/language-servers/issues/1332)) ([e030bdd](https://github.com/tsmithsz/language-servers/commit/e030bdd2f0daf61c062f64baa92563b539746e71))
